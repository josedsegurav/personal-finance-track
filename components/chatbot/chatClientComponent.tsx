...
export default function ChatClientComponent({data, apiKey}: ChatClientComponentProps) {
                        ...
                        <ScrollArea className="flex-1 p-3 lg:p-4 bg-gray-50/30">
                            <div className="space-y-3 lg:space-y-4">
                                {messages.map((message) => (
                                    ...
                                    >
                                        <div
                                            className={`flex items-start space-x-2 max-w-[75%] ${message.sender === "user"
                                        ...
                                        >
                                            ...
                                            <div
                                                className={`rounded-lg px-3 py-2 shadow-sm ${message.sender === "user"
                                                    ? "bg-columbia-blue text-white"
