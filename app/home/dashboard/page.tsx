      ...
      <div className="flex-1 p-4 lg:p-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3 lg:gap-6 mb-6 lg:mb-8">
          ...
          <div className="bg-white p-4 lg:p-6 rounded-lg shadow-sm border border-gray-100">
            ...
            <p className={`text-xl lg:text-2xl font-semibold mb-1 ${balance >= 0 ? 'text-paynes-gray' : 'text-bittersweet'
              }`}>
              ${balance.toFixed(2)}
            </p>
            <p className={`text-xs lg:text-sm flex items-center ${balance >= 0 ? 'text-columbia-blue' : 'text-bittersweet'
              }`}>
